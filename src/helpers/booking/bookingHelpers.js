...
const createBookingData = async (requestData) => {
    try {
        ...
        let locationData = {
            bookingId: createRide && createRide.dataValues && createRide.dataValues.id,
            location: requestData.pickUpLocation,
            locationLat: requestData.pickUpLat,
            locationLng: requestData.pickUpLng,
        ...
        bookingLocationsData.push(locationData);

        locationData = {
            bookingId: createRide && createRide.dataValues && createRide.dataValues.id,
            location: requestData.dropOffLocation,
            locationLat: requestData.dropOffLat,
            locationLng: requestData.dropOffLng,
            locationStatus: 'pending',
            locationDistance: requestData.totalRideDistance,
            locationDistanceType: requestData.distanceType,
            locationDuration: requestData.totalDuration,
            locationUpdatedAt: new Date(),
            locationType: 'drop'
        };
